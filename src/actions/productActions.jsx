...
export const getProductByCategotyId = (id) => async (dispatch, getState) => {
  try {
    dispatch({ type: PRODUCT_CATEID_REQUEST })
console.log('616:',id);
    var config = {
      method: 'get',
      url: `http://localhost:8080/api/productelec/getcategory/${id}`,
      headers: { }
    };
